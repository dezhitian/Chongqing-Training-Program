...
path = ['tuila'];
list = dir(['D:\ti\mmwave_studio_02_00_00_02\shujuji\',path ,'\','*.bin']);
% list = dir(['D:\suiyi\data\手势识别\mimo_raw_data','\','*.bin']);
k = length(list);
path2 = ['D:\ti\mmwave_studio_02_00_00_02\xunlianji\',path ];
mkdir(path2);
for iii =1:k
    str = strcat('D:\ti\mmwave_studio_02_00_00_02\shujuji\',path,'\',list(iii).name);
