...
Path = 'C:\Users\tian1017\Desktop\雷达手势识别\左滑测试数据\';                   % 设置数据存放的文件夹路径
...
for k = 1 : Length_Names
    ...
    for n=1:32
        sgn_1=adcData_2(:,(n-1)*det+1:(n-1)*det+Ns);
    ...
    angle_rr=angle_r(120:240,1:2:32);
    ...
    f=getframe(gcf);
    imwrite(f.cdata,['C:\Users\tian1017\Desktop\Dataset\2\左滑角度',num2str(k),'.jpg'])
end